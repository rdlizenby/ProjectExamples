...
namespace SGBank.BLL
{
    public class AccountManager
    {
        ...
        public AccountManager(IAccountRepository accountRepository) //constructor forces the application to get a concrete instance of AccountRepository
        {
            _accountRepository = accountRepository;  //and saves it to the private field
        }
        ...
        public AccountLookupResponse LookupAccount(string accountNumber)  
        {
            ...
            if(response.Account == null)            //account number doesn't exist
            {
