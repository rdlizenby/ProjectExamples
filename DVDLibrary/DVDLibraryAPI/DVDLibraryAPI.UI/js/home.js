$(document).ready(function () {
    ...
    $('#create-button').click(function (event) {
        ...
        if (($('#create-dvd-title').val() === '') || (($('#create-release-year').val() < 1000) || ($('#create-release-year').val() > 9999))) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://dvdlibraryproject.azurewebsites.net/dvd',
                data: JSON.stringify({
    ...
    $('#edit-button').click(function (event) {
        ...
        if (($('#edit-dvd-title').val() === '') || (($('#edit-release-year').val() < 1000) || ($('#edit-release-year').val() > 9999))) {
            ...
            $.ajax({
                type: 'PUT',
                url: 'http://dvdlibraryproject.azurewebsites.net/dvd/' + $('#edit-dvd-id').val(),
                data: JSON.stringify({
...
function loadDvds() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://dvdlibraryproject.azurewebsites.net/dvds',
...
function showDvdDetails(dvdId) {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://dvdlibraryproject.azurewebsites.net/dvd/' + dvdId,
...
function search() {
    ...
    if ((searchCategory.val() === "Search Category") || (searchTerm.val() === "")) {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://dvdlibraryproject.azurewebsites.net/dvds/' + searchCategory.val().toLowerCase() + '/' + searchTerm.val(),
            success: function (dvdArray) {
                $('#contentRows').empty();
                $.each(dvdArray, function (index, dvd) {
