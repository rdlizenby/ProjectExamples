...
function loadItems() {
    $.ajax({
        type: 'GET',
        url: 'http://guildcars.azurewebsites.net/items/',
...
function makePurchase() {
    ...
    if (itemCost > deposited) {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://guildcars.azurewebsites.net/money/' + document.getElementById("deposited").textContent + '/item/' + document.getElementById("item-choice").textContent,
